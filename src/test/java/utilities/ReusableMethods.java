...
public class ReusableMethods {
    ...
    public static void clickabilityWait(WebElement element, int timeoutInSeconds) {
    ...
    public static String takeScreenshot(WebDriver driver, String testName) {
        ...
        String destination = System.getProperty("user.dir") + "/target/Screenshots/" + testName + "_" + dateName + ".png";
